...
public class CheckoutPage {
	...
	private By valorFrete = By.cssSelector("span.carrier-price");
	...
	public String obter_valorFrete() {
		return driver.findElement(valorFrete).getText();
	}
	...
	public boolean checkboxIAgreeSelecionado() {
